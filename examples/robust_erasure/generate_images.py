...
def parse_args():
    ...
    parser.add_argument("--model_path_ti", type=str, help="Path to model checkpoint for textual inversion", default="")
...
if __name__ == "__main__":
    ...
    if args.model_path_ti != "":
        pipe.load_textual_inversion(args.model_path_ti)
